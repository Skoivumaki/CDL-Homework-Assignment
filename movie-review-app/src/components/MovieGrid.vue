...
<template>
  <div class="flex flex-row h-full">
    <ul
      class="flex flex-wrap gap-10 list-none transition-all duration-500 w-full min-w-0 md:min-w-170 h-fit px-2 justify-center">
    ...
    <Transition name="transitionWidth">
      <div v-if="isViewVisible" @click.self="closeDetails"
        class="fixed inset-0 overflow-y-auto bg-white md:sticky md:h-screen">
